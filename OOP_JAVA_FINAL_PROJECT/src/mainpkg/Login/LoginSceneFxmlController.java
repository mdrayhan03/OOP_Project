...
//                    ds.set(u);
                ...
                else if ("Doctor".equals(u.getUserType())) {
                            FXMLLoader fx = fxmlload("/mainpkg/Saima/User3_Doctor/DoctorDashBoardSceneFxml.fxml" , "Doctor" , event) ;
                            System.out.println("Dortor") ;
                            DoctorDashBoardSceneFxmlController ds = fx.getController() ;
                            ds.set((Doctor) u) ;
                        }
