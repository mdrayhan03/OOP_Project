 ...
 * @author synt4x_err0r
 */
public class SelectedForJobController implements Initializable {

    @FXML
    private Label selectedForJobLabel;
    ...
    @FXML
    private void selectedForJobBackButton(ActionEvent event) throws IOException {
